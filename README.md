...
| **Stadt** |  |
| <img src="images/cards/Stadt.jpeg" alt="stadt" width="500"/> | **Kosten**: 3x Erz, 2x Getreide, 1x Siedlung<br> **Kurzbeschrieb**: 3 beliebige Ressourcen<br> **Beschreibung**: Zählt als 3 Ressourcen nach Wahl. Dies können 3 unterschiedliche Resourcen sein. Die Stadt wird benötigt um das Spiel zu gewinnen. Die Aktion der Siedlung kann nicht verwendet werden, um eine Stadt zu erwerben (Die Siedlung muss noch unausgespielt auf der Hand sein. Die Siedlung wird danach zurück auf den Vorrat gelegt). |
